 ...
 */
@ApplicationScoped
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/home/jithin/Desktop/soap/test.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/jithin/Desktop/soap/test.wsdl");
